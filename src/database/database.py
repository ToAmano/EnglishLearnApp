...
def insert_sample_data():
    ...
    cursor.execute("INSERT INTO meanings (word_id, meaning, part_of_speech, category) VALUES (1, '輝いている', 'adj', '天気')")
    cursor.execute("INSERT INTO meanings (word_id, meaning, part_of_speech, category) VALUES (1, '頭が良い', 'adj', '性格')")
    cursor.execute("INSERT INTO meanings (word_id, meaning, part_of_speech, category) VALUES (2, '暗い', 'adj', '天気')")
    # brightness: 明るさ（名詞）
    cursor.execute("""
    ...
    cursor.execute("INSERT INTO examples (word_id, example, audio_path) VALUES (1, 'The sun is bright today.', 'audio/bright1.mp3')")
    cursor.execute("INSERT INTO examples (word_id, example, audio_path) VALUES (2, 'The room is dark.', 'audio/dark1.mp3')")
    ...
    for word in derived_words:
        ...
        cursor.execute("INSERT OR IGNORE INTO derived_words (word_id, stem_id) VALUES (?, ?)", (word_id, stem_id))
    
    # 類義語の登録: bright と brightness
    cursor.execute("INSERT OR IGNORE INTO synonyms (word_id_1, word_id_2) VALUES (?, ?)", (1, 3))
    cursor.execute("INSERT OR IGNORE INTO synonyms (word_id_1, word_id_2) VALUES (?, ?)", (3, 1))  # 双方向
